...
class Query:
    ...
    def update(self, primary_key, *columns):
        ...
        # Write record to tail page, get offset
        tail_page.write(record)

        # Update page directory, key is base rid, value is list of tail page path
        if lineage[0].rid not in self.table.page_directory:
            self.table.page_directory[lineage[0].rid] = []
        self.table.page_directory[lineage[0].rid].append(new_tail_page_path)
